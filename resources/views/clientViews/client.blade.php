...
<body class="preload-wrapper popup-loader">
                ...
                <div class="row wrapper-header align-items-center">
                    ...
                    <div class="col-xl-3 col-md-4 col-6">
                        <a href="index.html" class="logo-header">
                            <img src="{{ asset('clientFront/assets/images/logo/logo.svg') }}" alt="logo" class="logo">
                        </a>
                    </div>
                                            ...
                                            <div class="row-demo">
                                                <div class="demo-item">
                                                    <a href="index.html">
                                                        <div class="demo-image position-relative">
                                                            <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-01.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-01.jpg') }}" alt="home-01">
                                                ...
                                                <div class="demo-item">
                                                    <a href="home-multi-brand.html">
                                                        <div class="demo-image position-relative">
                                                            <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-multi-brand.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-multi-brand.jpg') }}" alt="home-multi-brand">
                                                            <div class="demo-label">
                                                                <span class="demo-new">New</span>
                                                ...
                                                <div class="demo-item">
                                                    <a href="home-02.html">
                                                        <div class="demo-image position-relative">
                                                            <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-02.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-02.jpg') }}" alt="home-02">
                                                            <div class="demo-label">
                                                                <span class="demo-hot">Hot</span>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="demo-item">
                                                    <a href="home-03.html">
                                                        <div class="demo-image">
                                                            <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-03.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-03.jpg') }}" alt="home-03">
                                                        </div>
                                                ...
                                                <div class="demo-item">
                                                    <a href="home-04.html">
                                                        <div class="demo-image">
                                                            <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-04.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-04.jpg') }}" alt="home-04">
                                                        </div>
                                                ...
                                                <div class="demo-item">
                                                    <a href="home-05.html">
                                                        <div class="demo-image">
                                                            <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-05.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-05.jpg') }}" alt="home-05">
                                                        </div>
                                                ...
                                                <div class="demo-item">
                                                    <a href="home-06.html">
                                                        <div class="demo-image position-relative">
                                                            <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-06.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-06.jpg') }}" alt="home-06">
                                                            <div class="demo-label">
                                                                <span class="demo-new">New</span>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="demo-item">
                                                    <a href="home-07.html">
                                                        <div class="demo-image">
                                                            <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-07.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-07.jpg') }}" alt="home-07">
                                                        </div>
                                                ...
                                                <div class="demo-item">
                                                    <a href="home-08.html">
                                                        <div class="demo-image">
                                                            <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-08.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-08.jpg') }}" alt="home-08">
                                                        </div>
                                                ...
                                                <div class="demo-item">
                                                    <a href="home-skincare.html">
                                                        <div class="demo-image">
                                                            <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-skincare.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-skincare.jpg') }}" alt="home-skincare">
                                                        </div>
                                                ...
                                                <div class="demo-item">
                                                    <a href="home-headphone.html">
                                                        <div class="demo-image">
                                                            <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-headphone.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-headphone.jpg') }}" alt="home-headphone">
                                                        </div>
                                                ...
                                                <div class="demo-item">
                                                    <a href="home-giftcard.html">
                                                        <div class="demo-image">
                                                            <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-giftcard.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-giftcard.jpg') }}" alt="home-gift-card">
                                                        </div>
                                                    ...
                                                    <div class="collection-item hover-img">
                                                        <div class="collection-inner">
                                                            <a href="shop-men.html" class="collection-image img-style">
                                                                <img class="lazyload" data-src="{{ asset('clientFront/assets/images/collections/collection-1.jpg') }}" src="{{ asset('clientFront/assets/images/collections/collection-1.jpg') }}" alt="collection-demo-1">
                                                            </a>
                                                    ...
                                                    <div class="collection-item hover-img">
                                                        <div class="collection-inner">
                                                            <a href="shop-women.html" class="collection-image img-style">
                                                                <img class="lazyload" data-src="{{ asset('clientFront/assets/images/collections/collection-2.jpg') }}" src="{{ asset('clientFront/assets/images/collections/collection-2.jpg') }}" alt="collection-demo-1">
                                                            </a>
                                                            <div class="collection-content">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="wrap-slider">
                            <img src="{{ asset('clientFront/assets/images/slider/fashion-slideshow-01.jpg') }}" alt="fashion-slideshow">
                    ...
                    <div class="swiper-slide">
                        <div class="wrap-slider">
                            <img src="{{ asset('clientFront/assets/images/slider/fashion-slideshow-02.jpg') }}" alt="fashion-slideshow">
                            <div class="box-content">
                                <div class="container">
                    ...
                    <div class="swiper-slide">
                        <div class="wrap-slider">
                            <img src="{{ asset('clientFront/assets/images/slider/fashion-slideshow-03.jpg') }}" alt="fashion-slideshow">
                            <div class="box-content">
                                <div class="container">
                                    <h1 class="fade-item fade-item-1">Glamorous<br>Glam</h1>
                                    <p class="fade-item fade-item-2">From casual to formal, we've got you covered</p>
                            ...
                            <div class="swiper-wrapper">
                                    ...
                                    <div class="collection-item style-left hover-img">
                                        <div class="collection-inner">
                                            <a href="shop-default.html" class="collection-image img-style">
                                                <img class="lazyload" data-src="{{ asset('clientFront/assets/images/collections/collection-17.jpg') }}" src="{{ asset('clientFront/assets/images/collections/collection-17.jpg') }}" alt="collection-img">
                                            </a>
                                            <div class="collection-content">
                                ...
                                <div class="swiper-slide" lazy="true">
                                    <div class="collection-item style-left hover-img">
                                        <div class="collection-inner">
                                            <a href="shop-default.html" class="collection-image img-style">
                                                <img class="lazyload" data-src="{{ asset('clientFront/assets/images/collections/collection-14.jpg') }}" src="{{ asset('clientFront/assets/images/collections/collection-14.jpg') }}" alt="collection-img">
                                            </a>
                                            <div class="collection-content">
                                ...
                                <div class="swiper-slide" lazy="true">
                                    <div class="collection-item style-left hover-img">
                                        <div class="collection-inner">
                                            <a href="shop-default.html" class="collection-image img-style">
                                                <img class="lazyload" data-src="{{ asset('clientFront/assets/images/collections/collection-18.jpg') }}" src="{{ asset('clientFront/assets/images/collections/collection-18.jpg') }}         " alt="collection-demo-1">
                                            </a>
                                            <div class="collection-content">
                                ...
                                <div class="swiper-slide" lazy="true">
                                    <div class="collection-item style-left hover-img">
                                        <div class="collection-inner">
                                            <a href="shop-default.html" class="collection-image img-style">
                                                <img class="lazyload" data-src="{{ asset('clientFront/assets/images/collections/collection-15.jpg') }}" src="{{ asset('clientFront/assets/images/collections/collection-15.jpg') }}" alt="collection-demo-1">
                                            </a>
                                            <div class="collection-content">
                                ...
                                <div class="swiper-slide" lazy="true">
                                    <div class="collection-item style-left hover-img">
                                        <div class="collection-inner">
                                            <a href="shop-default.html" class="collection-image img-style">
                                                <img class="lazyload" data-src="{{ asset('clientFront/assets/images/collections/collection-20.jpg') }}" src="{{ asset('clientFront/assets/images/collections/collection-20.jpg') }}" alt="collection-demo-1">
                                            </a>
                                            <div class="collection-content">
                    ...
                    <div class="row-demo">
                        ...
                        <div class="demo-item">
                            <a href="home-furniture.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-furniture.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-furniture.jpg') }}" alt="home-furniture">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-furniture-02.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-furniture2.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-furniture2.jpg') }}" alt="home-furniture-2">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-skateboard.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-skateboard.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-skateboard.jpg') }}" alt="home-skateboard">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-stroller.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-stroller.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-stroller.jpg') }}" alt="home-stroller">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-decor.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-decor.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-decor.jpg') }}" alt="home-decor">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-electronic.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-electronic.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-electronic.jpg') }}" alt="home-electronic">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-setup-gear.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-setup-gear.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-setup-gear.jpg') }}" alt="home-setup-gear">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-dog-accessories.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-dog-accessories.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-dog-accessories.jpg') }}" alt="home-dog-accessories">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-kitchen-wear.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-kitchen.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-kitchen.jpg') }}" alt="home-kitchen-wear">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-phonecase.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-phonecase.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-phonecase.jpg') }}" alt="home-phonecase">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-paddle-boards.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home_paddle_board.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home_paddle_board.jpg') }}" alt="home-paddle_board">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-glasses.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-glasses.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-glasses.jpg') }}" alt="home-glasses">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-pod-store.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-pod-store.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-pod-store.jpg') }}" alt="home-pod-store">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-activewear.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-activewear.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-activewear.jpg') }}" alt="home-activewear">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-handbag.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-handbag.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-handbag.jpg') }}" alt="home-handbag">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-tee.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-tee.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-tee.jpg') }}" alt="home-tee">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-sock.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-socks.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-socks.jpg') }}" alt="home-sock">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-jewerly.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-jewelry.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-jewelry.jpg') }}" alt="home-jewelry">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-sneaker.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-sneaker.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-sneaker.jpg') }}" alt="home-sneaker">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-accessories.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-accessories.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-accessories.jpg') }}" alt="home-accessories">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-grocery.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-gocery.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-gocery.jpg') }}" alt="home-grocery">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-baby.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="{{ asset('clientFront/assets/images/demo/home-baby.jpg') }}" src="{{ asset('clientFront/assets/images/demo/home-baby.jpg') }}" alt="home-baby">
                                </div>
                        ...
                        <div class="tf-col-content">
                            ...
                            <div class="tf-search-hidden-inner">
                                ...
                                <div class="tf-loop-item">
                                    <div class="image">
                                        <a href="product-detail.html">
                                            <img src="{{ asset('clientFront/assets/images/products/white-1.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="content">
                ...
                <ul class="nav-ul-mb" id="wrapper-menu-navigation">
                    <li class="nav-mb-item">
                        <a href="shop-default.html" class="tf-category-link mb-menu-link">
                            <div class="image">
                                <img src="{{ asset('clientFront/assets/images/shop/cate/cate1.jpg') }}" alt="">
                            </div>
                    ...
                    <li class="nav-mb-item">
                        <a href="shop-default.html" class="tf-category-link mb-menu-link">
                            <div class="image">
                                <img src="{{ asset('clientFront/assets/images/shop/cate/cate2.jpg') }}" alt="">
                            </div>
                            <span>Dog</span>
                        </a>
                    </li>
                    <li class="nav-mb-item">
                        <a href="shop-default.html" class="tf-category-link mb-menu-link">
                            <div class="image">
                                <img src="{{ asset('clientFront/assets/images/shop/cate/cate3.jpg') }}  " alt="">
                            </div>
                            <span>Grocery</span>
                        </a>
                    </li>
                    <li class="nav-mb-item">
                        <a href="shop-default.html" class="tf-category-link mb-menu-link">
                            <div class="image">
                                <img src="{{ asset('clientFront/assets/images/shop/cate/cate4.png') }}" alt="">
                            </div>
                            <span>Handbag</span>
                        </a>
                    </li>
                    <li class="nav-mb-item">
                        <a href="#cate-menu-one" class="tf-category-link has-children collapsed mb-menu-link" data-bs-toggle="collapse" aria-expanded="true" aria-controls="cate-menu-one">
                            <div class="image">
                                <img src="{{ asset('clientFront/assets/images/shop/cate/cate5.jpg') }}" alt="">
                            </div>
                            <span>Fashion</span>
                            <span class="btn-open-sub"></span>
                        </a>
                                    ...
                                    <div id="cate-shop-one" class="collapse">
                                        <ul class="sub-nav-menu sub-menu-level-2">
                                            ...
                                            <li>
                                                <a href="shop-default.html" class="tf-category-link sub-nav-link">
                                                    <div class="image">
                                                        <img src="{{ asset('clientFront/assets/images/shop/cate/cate8.jpg') }}" alt="">
                                                    </div>
                                                    <span>Shoes</span>
                                                </a>
                                            </li>
                                    ...
                                    <div id="cate-shop-two" class="collapse">
                                        <ul class="sub-nav-menu sub-menu-level-2">
                                            ...
                                            <li>
                                                <a href="shop-default.html" class="tf-category-link sub-nav-link">
                                                    <div class="image">
                                                        <img src="{{ asset('clientFront/assets/images/shop/cate/cate7.jpg') }}" alt="">
                                                    </div>
                                                    <span>Tee</span>
                                                </a>
                                            </li>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <label class="d-flex align-items-center">
                                ...
                                <span class="btn-link link small">Remember me</span>
                            </label>
                                ...
                                <div class="tf-compare-offcanvas">
                                    <div class="tf-compare-item">
                                        <div class="position-relative">
                                            ...
                                            <a href="product-detail.html">
                                                <img class="radius-3" src="{{ asset('clientFront/assets/images/products/orange-1.jpg') }}" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="tf-compare-item">
                                        <div class="position-relative">
                                            ...
                                            <a href="product-detail.html">
                                                <img class="radius-3" src="{{ asset('clientFront/assets/images/products/pink-1.jpg') }} " alt="">
                                            </a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="wrap">
                    <div class="tf-product-info-item">
                        <div class="image">
                            <img src="{{ asset('clientFront/assets/images/products/orange-1.jpg') }}" alt="">
                        </div>
                        <div class="content">
            ...
            <div class="modal-content">
                ...
                <div class="tf-rte">
                    ...
                    <div class="tf-page-size-chart-content">
                        ...
                        <div>
                            <img class="sizechart lazyload" data-src="{{ asset('clientFront/assets/images/shop/products/size_chart2.jpg') }}" src="{{ asset('clientFront/assets/images/shop/products/size_chart2.jpg') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal modalCentered fade auto-popup modal-newleter">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-top">
                    <img class="lazyload" data-src="{{ asset('clientFront/assets/images/item/banner-newleter.jpg') }}" src="{{ asset('clientFront/assets/images/item/banner-newleter.jpg') }}" alt="home-01">
    ...
    <!-- Javascript -->
    <script type="text/javascript" src="{{ asset('clientFront/assets/js/bootstrap.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('clientFront/assets/js/jquery.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('clientFront/assets/js/swiper-bundle.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('clientFront/assets/js/carousel.js') }}"></script>
    <script type="text/javascript" src="{{ asset('clientFront/assets/js/bootstrap-select.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('clientFront/assets/js/lazysize.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('clientFront/assets/js/count-down.js') }}"></script>
