                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-column gap-4">
                                <div class="d-flex align-items-center gap-4">
                                    <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                                        <div class="wh-48 d-flex align-items-center justify-content-center rounded-3 border">
                                            <img src="{{ asset('adminFront/assets/images/projects/angular.png') }}  " width="30" alt="">
                                        </div>
                                        <div class="">
                                ...
                                <div class="d-flex align-items-center gap-4">
                                    <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                                        <div class="wh-48 d-flex align-items-center justify-content-center rounded-3 border">
                                            <img src="{{ asset('adminFront/assets/images/projects/react.png') }}  " width="30" alt="">
                                        </div>
                                        <div class="">
                                ...
                                <div class="d-flex align-items-center gap-4">
                                    <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                                        <div class="wh-48 d-flex align-items-center justify-content-center rounded-3 border">
                                            <img src="{{ asset('adminFront/assets/images/projects/vue.png') }}  " width="30" alt="">
                                        </div>
                                        <div class="">
                                ...
                                <div class="d-flex align-items-center gap-4">
                                    <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                                        <div class="wh-48 d-flex align-items-center justify-content-center rounded-3 border">
                                            <img src="{{ asset('adminFront/assets/images/projects/bootstrap.png') }}  " width="30" alt="">
                                        </div>
                                        <div class="">
                                ...
                                <div class="d-flex align-items-center gap-4">
                                    <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                                        <div class="wh-48 d-flex align-items-center justify-content-center rounded-3 border">
                                            <img src="{{ asset('adminFront/assets/images/projects/magento.png') }}  " width="30" alt="">
                                        </div>
                                        <div class="">
                                ...
                                <div class="d-flex align-items-center gap-4">
                                    <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                                        <div class="wh-48 d-flex align-items-center justify-content-center rounded-3 border">
                                            <img src="{{ asset('adminFront/assets/images/projects/django.png') }}  " width="30" alt="">
                                        </div>
                                        <div class="">
                                ...
                                <div class="d-flex align-items-center gap-4">
                                    <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                                        <div class="wh-48 d-flex align-items-center justify-content-center rounded-3 border">
                                            <img src="{{ asset('adminFront/assets/images/projects/python.png') }}  " width="30" alt="">
                                        </div>
                                        <div class="">
                            ...
                            <div class="d-flex flex-column justify-content-between gap-4">
                                <div class="d-flex align-items-center gap-4">
                                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                                        <img src="{{ asset('adminFront/assets/images/apps/17.png') }}   " width="32" alt="">
                                ...
                                <div class="d-flex align-items-center gap-4">
                                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                                        <img src="{{ asset('adminFront/assets/images/apps/18.png') }}   " width="32" alt="">
                                ...
                                <div class="d-flex align-items-center gap-4">
                                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                                        <img src="{{ asset('adminFront/assets/images/apps/19.png') }}   " width="32" alt="">
                                ...
                                <div class="d-flex align-items-center gap-4">
                                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                                        <img src="{{ asset('adminFront/assets/images/apps/20.png') }}   " width="32" alt="">
                                ...
                                <div class="d-flex align-items-center gap-4">
                                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                                        <img src="{{ asset('adminFront/assets/images/apps/05.png') }}   " width="32" alt="">
                                ...
                                <div class="d-flex align-items-center gap-4">
                                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                                        <img src="{{ asset('adminFront/assets/images/apps/08.png') }}   " width="32" alt="">
                                ...
                                <div class="d-flex align-items-center gap-4">
                                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                                        <img src="{{ asset('adminFront/assets/images/apps/07.png') }}   " width="32" alt="">
                                ...
                                <div class="d-flex align-items-center gap-4">
                                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                                        <img src="{{ asset('adminFront/assets/images/apps/12.png') }}     " width="32" alt="">
                ...
                <div class="col-12 col-xl-12 d-flex">
                    <div class="card w-100 rounded-4">
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-column gap-4">
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{ asset('adminFront/assets/images/orders/01.png') }}       " width="78" class="rounded-3" alt="">
                                    <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{ asset('adminFront/assets/images/orders/08.png') }}       " width="78" class="rounded-3" alt="">
                                    <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{ asset('adminFront/assets/images/orders/03.png') }}       " width="78" class="rounded-3" alt="">
                                    <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{ asset('adminFront/assets/images/orders/04.png') }}       " width="78" class="rounded-3" alt="">
                                    <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{ asset('adminFront/assets/images/orders/05.png') }}       " width="78" class="rounded-3" alt="">
                                    <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{ asset('adminFront/assets/images/orders/06.png') }}       " width="75" class="rounded-3" alt="">
                                    <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{ asset('adminFront/assets/images/orders/07.png') }}       " width="78" class="rounded-3" alt="">
                                    <div class="flex-grow-1">
